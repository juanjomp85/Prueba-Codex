...
const STORAGE_KEY = "keep-mini-cards";
...
/** @type {Array<{id:string,type:'note'|'task',title:string,content:string,color:string,done:boolean,createdAt:string}>} */
let cards = loadCards();
let searchTerm = "";
...
clearCompletedButton.addEventListener("click", () => {
  cards = cards.filter((card) => !(card.type === "task" && card.done));
  persistCards();
  renderCards();
});
